...
public sealed class PostgresProvider(string connStr, string adminConnStr) : IDbProvider
{
    ...
    public async Task<double> GetIndexSizeAsync()
    {
        await using var conn = new NpgsqlConnection(connStr);
        await conn.OpenAsync();
        await using var cmd = conn.CreateCommand();
        cmd.CommandText = "SELECT pg_indexes_size('benchmark_rows')";
